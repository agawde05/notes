...
% change chapter name and new page
\renewcommand{\chaptername}{Lecture}
% make chapter page also fancy
\usepackage{etoolbox}
...
% Definition - BlueViolet
% Example - Mulberry
% Lemma - WildStrawberry
...
\declaretheoremstyle[
    ...
    mdframed={
        ...
        linecolor=BlueViolet, backgroundcolor=BlueViolet!5,
    }
]{thmgreenbox}
...
\declaretheoremstyle[
    ...
    mdframed={
        linewidth=2pt,
        rightline=false, topline=false, bottomline=false,
        linecolor=Mulberry, backgroundcolor=Mulberry!1,
    },
]{thmexplanationbox}
...
\def\@lecturedate{}%
\newcommand{\lecturedate}[3]{
    \def\@lecturedate{#1, #2 #3}
}
...
% \fancyhead[LE,RO]{Atharva Gawde}
% \fancyhead[RO,LE]{\@vorlesung}
\fancyhead[RO,LE]{\@lecturedate}
\fancyhead[RE,LO]{}
